...
class DetailAll extends ConsumerWidget {
  final String? idPost;
  final String? img;
  final int? price;
  final String? naim;
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
        ...
        body: Stack(
          children: [
            ListView.builder(
                itemCount: listDetail(context: context).length,
                itemBuilder: (context, index) {
                  return Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 15.0),
                    child: listDetail(context: context)[index],
                  );
                }),
  ...
  List<Widget> listDetail({required BuildContext context}) {
    List<Widget> listWidgetDetail;
    return listWidgetDetail = [
      DiscountSwipeWidget(
          height: Get.width,
      ...
      Column(
        children: [
          ...
          SizedBox(height: 12),
          widgets.arrowButton(
              icon: 'wallet', label: 'payment_сonvenient_way', index: 1),
          SizedBox(height: 12),
          widgets.arrowButton(
